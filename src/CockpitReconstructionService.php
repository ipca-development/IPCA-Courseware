...
final class CockpitReconstructionService
{
    ...
    private function publicG3XFields(array $row): array
    {
        ...
        return array(
            ...
            'coolant1_f' => $num($g3x, 'CHT1 (deg F)', 'Cylinder Head Temp 1 (deg F)', 'Coolant Temp 1 (deg F)'),
            'coolant2_f' => $num($g3x, 'CHT2 (deg F)', 'Cylinder Head Temp 2 (deg F)', 'Coolant Temp 2 (deg F)'),
