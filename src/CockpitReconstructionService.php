...
final class CockpitReconstructionService
{
    ...
    private const G3X_COLUMNS = array(
        ...
        'CHT1 (deg F)',
        'CHT2 (deg F)',
        'Cylinder Head Temp 1 (deg F)',
        'Cylinder Head Temp 2 (deg F)',
    ...
    private function compactReplaySample(array $sample): array
    {
        $fields = array(
            ...
            'elevator_trim_pct',
            'fd_roll_command_deg',
            'fd_pitch_command_deg',
            'fd_altitude_ft',
            'ap_roll_command_deg',
            'ap_pitch_command_deg',
            'ap_vs_command_fpm',
            'ap_altitude_command_ft',
            'ap_roll_torque_pct',
            'ap_pitch_torque_pct',
            'com1_mhz',
            'com1_standby_mhz',
    ...
    private function publicG3XFields(array $row): array
    {
        ...
        return array(
            ...
            'coolant1_f' => $num($g3x, 'Coolant Temp 1 (deg F)', 'Coolant Temp1 (deg F)', 'CHT1 (deg F)', 'Cylinder Head Temp 1 (deg F)'),
            'coolant2_f' => $num($g3x, 'Coolant Temp 2 (deg F)', 'Coolant Temp2 (deg F)', 'CHT2 (deg F)', 'Cylinder Head Temp 2 (deg F)'),
