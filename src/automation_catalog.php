...
if (!function_exists('automation_default_event_definitions')) {
    function automation_default_event_definitions(): array
    {
        return array(
            ...
            array(
                'event_key' => 'deadline_pending_reason_decision_escalated',
                'label' => 'Deadline — pending reason decision escalated to instructor',
                'description' => "Q8: engine reached missed-deadline handling while the student's earlier deadline reason submission is still awaiting instructor decision. The engine refuses to auto-extend and creates an instructor_approval action instead.",
                'category_key' => 'theory_training',
                'sort_order' => 140,
            ),
            array(
                'event_key' => 'deadline_rejected_reason_review_required',
                'label' => 'Deadline — rejected reason needs further review',
                'description' => 'Q8: engine reached missed-deadline handling after the instructor already rejected a previous reason. Routes to instructor_approval for a fresh corrective-action decision.',
                'category_key' => 'theory_training',
                'sort_order' => 145,
            ),
            array(
                'event_key' => 'deadline_extension_refused_past_due',
                'label' => 'Deadline — automatic extension refused (would be past-due)',
                'description' => 'Q9: an automatic extension was refused because the projected new deadline was already in the past at the moment of evaluation. Engine creates an instructor_approval action so a human can decide whether to issue a manual fresh extension.',
                'category_key' => 'theory_training',
                'sort_order' => 150,
            ),
            array(
                'event_key' => 'instructor_pending_reason_decision_reminder',
                'label' => 'Instructor reminder — pending reason decision',
                'description' => 'Daily nudge: lesson_activity.reason_decision is "pending" (student submitted, instructor has not yet decided). Dispatched at most once per UTC calendar day per lesson by TimeBasedProgressionCron.',
                'category_key' => 'theory_training',
                'sort_order' => 155,
            ),
            array(
