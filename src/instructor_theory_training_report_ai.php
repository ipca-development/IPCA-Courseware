    ...
    public static function callOpenAiForReportJson(array $context, string $studentName, string $cohortTitle): array
    {
        ...
        $payload = [
            ...
            'rules' => [
                ...
                'Where regulations apply, cite 14 CFR parts/sections and applicable Advisory Circular identifiers, and state that the instructor must verify current wording on https://www.ecfr.gov/ and https://www.faa.gov/ (official sources).',
