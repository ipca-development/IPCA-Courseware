    ...
    public static function variableCatalog(): array
    {
        return array(
            array('group' => 'Student profile', 'variables' => array(
                ...
                array('key' => 'student.pilot_certificate_number', 'token' => '{{student.pilot_certificate_number}}', 'label' => 'Student pilot certificate number'),
                array('key' => 'student.pilot_certificate_level', 'token' => '{{student.pilot_certificate_level}}', 'label' => 'Student pilot certificate level'),
                array('key' => 'student.medical_certificate_class', 'token' => '{{student.medical_certificate_class}}', 'label' => 'Student medical certificate class'),
                array('key' => 'student.medical_certificate_expiration_date', 'token' => '{{student.medical_certificate_expiration_date}}', 'label' => 'Student medical expiration'),
                array('key' => 'student.signature_url', 'token' => '{{student.signature_url}}', 'label' => 'Student signature image URL'),
            )),
            array('group' => 'Instructor profile', 'variables' => array(
                ...
                array('key' => 'instructor.instructor_certificate_number', 'token' => '{{instructor.instructor_certificate_number}}', 'label' => 'Instructor certificate number'),
                array('key' => 'instructor.instructor_certificate_expiration_date', 'token' => '{{instructor.instructor_certificate_expiration_date}}', 'label' => 'Instructor certificate expiration'),
                array('key' => 'instructor.signature_url', 'token' => '{{instructor.signature_url}}', 'label' => 'Instructor signature image URL'),
            )),
            ...
            array('group' => 'Knowledge test', 'variables' => array(
                ...
                array('key' => 'knowledge_test.deficient_codes', 'token' => '{{knowledge_test.deficient_codes}}', 'label' => 'Written test deficient codes'),
            )),
            ...
            array('group' => 'FAA Part 61 PPL', 'variables' => array(
                ...
                array('key' => 'faa61.ppl.first_solo.events', 'token' => '{{faa61.ppl.first_solo.events}}', 'label' => 'Tagged first solo flight'),
                array('key' => 'faa61.ppl.dual_cross_country_training.events', 'token' => '{{faa61.ppl.dual_cross_country_training.events}}', 'label' => 'Tagged dual cross-country training'),
                array('key' => 'faa61.ppl.dual_night_training.events', 'token' => '{{faa61.ppl.dual_night_training.events}}', 'label' => 'Tagged dual night training'),
                array('key' => 'faa61.ppl.dual_night_cross_country.events', 'token' => '{{faa61.ppl.dual_night_cross_country.events}}', 'label' => 'Tagged dual night cross-country'),
                array('key' => 'faa61.ppl.dual_night_takeoffs_landings.events', 'token' => '{{faa61.ppl.dual_night_takeoffs_landings.events}}', 'label' => 'Tagged dual night takeoffs/landings'),
                array('key' => 'faa61.ppl.dual_instrument_flight_training.events', 'token' => '{{faa61.ppl.dual_instrument_flight_training.events}}', 'label' => 'Tagged dual instrument training'),
                array('key' => 'faa61.ppl.solo_cross_country_flight.events', 'token' => '{{faa61.ppl.solo_cross_country_flight.events}}', 'label' => 'Tagged solo cross-country flight'),
                array('key' => 'faa61.ppl.long_150nm_solo_cross_country_flight.events', 'token' => '{{faa61.ppl.long_150nm_solo_cross_country_flight.events}}', 'label' => 'Tagged long 150 NM solo cross-country'),
                array('key' => 'faa61.ppl.towered_airport_takeoffs_landings.events', 'token' => '{{faa61.ppl.towered_airport_takeoffs_landings.events}}', 'label' => 'Tagged towered airport takeoffs/landings'),
