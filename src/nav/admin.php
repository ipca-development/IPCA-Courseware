    ...
    [
        ...
        'items' => [
            ...
            [
                ...
                'label' => 'Programs',
                'icon' => 'courses',
                'href' => '/admin/theory_studio/programs.php',
                'match_paths' => [
                    '/admin/theory_studio/programs.php',
                    '/admin/theory_studio/courses.php',
                    '/admin/theory_studio/lessons.php',
                    '/admin/theory_studio/lesson_editor.php',
                ],
            ],
            [
                ...
                'label' => 'Questions',
                'icon' => 'training',
                'href' => '/admin/question_manager.php',
            ],
            [
                'key' => 'bulk_enrich',
            ...
            [
                ...
                'label' => 'Lesson Enhancements',
                'icon' => 'enrich',
                'href' => '/admin/lesson_summary_blueprints.php',
            ],
            [
                'key' => 'theory_templates',
                'label' => 'Templates',
                'icon' => 'documents',
                'href' => '/admin/theory_studio/templates.php',
            ],
            [
            ...
            [
                'key' => 'legacy_templates',
                'label' => 'HTML Slot Templates',
                'icon' => 'documents',
                'href' => '/admin/templates.php',
            ],
        ],
    ],
    [
