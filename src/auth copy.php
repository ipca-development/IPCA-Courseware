...
| This file MUST NOT depend on admin-only UI/helper architecture.
|--------------------------------------------------------------------------
*/
...
if (!function_exists('ups_load_instructor_student_workspace')) {
    function ups_load_instructor_student_workspace(PDO $pdo, int $studentId, int $instructorId): ?array
    {
        /* PHASE 1 SECURITY GUARD:
           This function now validates that the caller is an active instructor-role user.
           Full instructor-to-student authorization/assignment enforcement is still TODO
