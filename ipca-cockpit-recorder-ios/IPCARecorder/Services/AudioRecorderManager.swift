...
final class AudioRecorderManager: NSObject, ObservableObject, AVAudioRecorderDelegate {
    ...
    var sourceSummary: String {
        ...
        if isAcceptedExternalInputActive {
            return "Recording source: external audio input (\(selectedInputName))"
        }
        if isInternalMicWarning {
            return "Recording source: iPad internal microphone"
        }
        return "Recording source: no accepted audio input selected"
    }
    ...
    func pauseRecording() {
        ...
        backgroundRecordingStatus = "Paused"
        updateMeters()
    }
    ...
    func resumeRecording() {
        ...
        backgroundRecordingStatus = recordingSignalActive ? "Recording" : "Recorder did not resume"
        updateMeters()
    }
    ...
    func stopRecording(language: String) -> Recording? {
        ...
        return Recording(
            ...
            aircraftType: nil,
            aircraftADSBHex: nil,
            altimeterSettingInHg: nil,
            airportElevationFt: nil,
            oatC: nil,
            fileSize: finalSize,
    ...
    func appDidEnterBackground() {
        ...
        updateMeters()
        recordingSignalActive = !isPaused && recorder?.isRecording == true
    ...
    private func updateMeters() {
        ...
        recordingSignalActive = isRecording && !isPaused && recorder.isRecording
        ...
        Task { @MainActor in
            ...
            case .ended:
                ...
                if shouldResumeAfterInterruption && options.contains(.shouldResume), let recorder {
                    ...
                    backgroundRecordingStatus = "Audio interruption ended, manual resume may be needed"
                    lastError = backgroundRecordingStatus
                }
