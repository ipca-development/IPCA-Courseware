...
CREATE TABLE IF NOT EXISTS ipca_admin_logbook_entries (
  ...
  fnpt_simulator_time           DECIMAL(8,2) NOT NULL DEFAULT 0.00,
  ...
  review_status                 VARCHAR(32) NOT NULL DEFAULT 'ok' COMMENT 'imported | needs_review | accepted | rejected | ok | flagged | merged | split | deleted',
  ...
  KEY idx_ipca_logbook_entries_import_profile (logbook_id, import_profile),
  KEY idx_ipca_logbook_entries_external (external_system, external_id),
  KEY idx_ipca_logbook_entries_sync_status (logbook_id, sync_status, review_status),
...
VALUES
  ...
  ('FAA_PART_61', 'PPL', 'towered_airport_landings', 'Towered Airport Full Stop Landings', 'Towered airport full-stop landings.', NULL, NULL, 3, JSON_OBJECT('type', 'filtered_sum', 'metric', 'towered_airport_landings', 'filters', JSON_ARRAY(JSON_OBJECT('field', 'solo_time', 'operator', 'gt', 'value', 0), JSON_OBJECT('field', 'towered_airport_landings', 'operator', 'gt', 'value', 0))), JSON_OBJECT()),
  ('FAA_PART_61', 'PPL', 'night_dual', 'Night Dual', 'Night dual instruction.', 3.0, NULL, NULL, JSON_OBJECT('type', 'filtered_sum', 'metric', 'night_time', 'filters', JSON_ARRAY(JSON_OBJECT('field', 'dual_received_time', 'operator', 'gt', 'value', 0), JSON_OBJECT('field', 'night_time', 'operator', 'gt', 'value', 0))), JSON_OBJECT()),
  ...
  ('FAA_PART_61', 'PPL', 'total_time', 'Total Time', 'Total flight time with up to 2.5 hours AATD/BATD credit.', 40.0, NULL, NULL, JSON_OBJECT('type', 'credited_total_time', 'sim_metric', 'fnpt_simulator_time', 'sim_credit_cap', 2.5), JSON_OBJECT()),
