...
SET
  allowed_variables_json = '[{"name":"student_name","label":"Student name","type":"text","safe_mode":"escaped","required":true,"sample_value":"John Smith","description":""},{"name":"lesson_title","label":"Lesson title","type":"text","safe_mode":"escaped","required":true,"sample_value":"Aerodynamics Basics","description":""},{"name":"course_title","label":"Course title","type":"text","safe_mode":"escaped","required":true,"sample_value":"Private Pilot","description":""},{"name":"auth_link","label":"Authentication link","type":"text","safe_mode":"escaped","required":true,"sample_value":"https://ipca.training/student/progress_test_auth.php?token=example","description":""},{"name":"expires_at","label":"Link expiry","type":"text","safe_mode":"escaped","required":true,"sample_value":"2026-06-03 22:00 UTC","description":""},{"name":"support_email","label":"Support email","type":"text","safe_mode":"escaped","required":false,"sample_value":"support@ipca.training","description":""},{"name":"student_email","label":"Student email","type":"text","safe_mode":"escaped","required":false,"sample_value":"student@example.com","description":""}]',
