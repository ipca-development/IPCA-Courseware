...
#ifndef IPCA_CVR_UNIT_SWIFT_H
#define IPCA_CVR_UNIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="IPCA_CVR_Unit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13IPCA_CVR_Unit20AudioRecorderManager")
@interface AudioRecorderManager : NSObject <AVAudioRecorderDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC13IPCA_CVR_Unit21AvionicsBeaconManager")
@interface AvionicsBeaconManager : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface AvionicsBeaconManager (SWIFT_EXTENSION(IPCA_CVR_Unit)) <CBPeripheralDelegate>
...
@class NSString;
@class NSNumber;
@interface AvionicsBeaconManager (SWIFT_EXTENSION(IPCA_CVR_Unit)) <CBCentralManagerDelegate>
...
SWIFT_CLASS("_TtC13IPCA_CVR_Unit18GPSLocationManager")
...
@class CLLocation;
@interface GPSLocationManager (SWIFT_EXTENSION(IPCA_CVR_Unit)) <CLLocationManagerDelegate>
