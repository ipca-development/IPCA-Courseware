        ...
        VStack(spacing: 8) {
            ...
            if workflow.state.activeDispatch == nil {
                ...
                CVRHoldActionButton(
                    ...
                    minimumDuration: 2,
                    asyncAction: {
                        guard !audio.isRecording else { return false }
                ...
                .disabled(isUndispatching || audio.isRecording)
                .opacity((isUndispatching || audio.isRecording) ? 0.55 : 1)
            } else {
                CVRHoldActionButton(
                    title: "DISPATCH NOW",
