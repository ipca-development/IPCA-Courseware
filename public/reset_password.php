...
function rp_h(string $value): string
{
...
<title>Reset Password · IPCA Academy</title>
...
<div class="access-shell">
    <div class="access-frame">
        ...
        <div class="access-card-wrap">
            <section class="access-card" aria-label="Reset password">
                <div class="access-card-head">
                    <div class="access-card-overline">Access Control</div>
                    <h2 class="access-card-title">Reset Password</h2>
                    <p class="access-card-subtitle">
                        Choose a new password for your IPCA Academy account.
                    </p>
                </div>
                ...
                <div class="access-card-body">
                    ...
                    <?php elseif (!$tokenRow): ?>
                        ...
                        <div class="access-actions">
                            <a class="access-btn access-btn--primary" href="/forgot_password.php">Request New Reset Link</a>
                            <a class="access-btn access-btn--secondary" href="/login.php">Back to Login</a>
                        </div>
                    <?php else: ?>
                        <div class="access-note">
                            Resetting password for <strong><?php echo rp_h(rp_display_name($tokenRow)); ?></strong>.
                        </div>
                        ...
                        <form method="post" action="/reset_password.php" novalidate>
                            ...
                            <div class="access-field">
                                ...
                                <input
                                    ...
                                    value="<?php echo rp_h($passwordConfirm); ?>"
                                    required
                                    autocomplete="new-password">
                            </div>
