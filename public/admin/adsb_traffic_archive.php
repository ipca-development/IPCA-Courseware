...
<div class="adsb-page">
  ...
  <section class="adsb-card">
    ...
    <form class="adsb-actions" method="post" action="/admin/api/adsb_archive_action.php">
      ...
      <label class="adsb-muted">Lookback minutes<br><input type="number" name="lookback_minutes" min="5" max="1440" value="180"></label>
