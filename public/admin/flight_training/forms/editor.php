            ...
            <div class="cpb-form-toolbar-row" aria-label="Form editor tools">
              <div class="cpb-toolbar-group cpb-form-toolbar-group">
                ...
                <select id="cpbFormVariableSelect" class="cpb-tool-select cpb-tool-select--form-variable" title="Insert variable">
                  ...
                  <option value="student.pilot_certificate_number">Student pilot certificate number</option>
                  <option value="student.medical_certificate_expiration_date">Student medical expiration</option>
                  <option value="student.signature_url">Student signature image URL</option>
                  ...
                  <option value="instructor.instructor_certificate_number">Instructor certificate number</option>
                  <option value="instructor.signature_url">Instructor signature image URL</option>
                  ...
                  <option value="knowledge_test.deficient_codes">Written test deficient codes</option>
                  <option value="faa61.ppl.first_solo.events">Tagged first solo flight</option>
                  <option value="faa61.ppl.dual_cross_country_training.events">Tagged dual cross-country training</option>
                  <option value="faa61.ppl.dual_night_training.events">Tagged dual night training</option>
                  <option value="faa61.ppl.dual_night_cross_country.events">Tagged dual night cross-country</option>
                  <option value="faa61.ppl.dual_night_takeoffs_landings.events">Tagged dual night takeoffs/landings</option>
                  <option value="faa61.ppl.dual_instrument_flight_training.events">Tagged dual instrument training</option>
                  <option value="faa61.ppl.solo_cross_country_flight.events">Tagged solo cross-country flight</option>
                  <option value="faa61.ppl.long_150nm_solo_cross_country_flight.events">Tagged long 150 NM solo cross-country</option>
                  <option value="faa61.ppl.towered_airport_takeoffs_landings.events">Tagged towered airport takeoffs/landings</option>
