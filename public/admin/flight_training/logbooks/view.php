...
.alogw-table-wrap{overflow-x:hidden;overflow-y:auto;max-height:720px;background:#fff}.alogw-table{width:100%;border-collapse:separate;border-spacing:0;table-layout:fixed;min-width:0;background:#fff}.alogw-table th{position:sticky;top:0;z-index:1;padding:5px 2px;background:#f8fafc;border-right:1px solid #e2e8f0;border-bottom:1px solid #cbd5e1;font-size:8px;line-height:1;white-space:nowrap;text-transform:uppercase;letter-spacing:0;color:#475569;text-align:center}.alogw-table td{padding:2px;border-right:1px solid #e2e8f0;border-bottom:1px solid #e2e8f0;vertical-align:middle;background:#fff}.alogw-table tr:nth-child(even) td{background:#f8fafc}.alogw-table input,.alogw-table textarea,.alogw-table select{width:100%;height:21px;box-sizing:border-box;border:1px solid rgba(15,23,42,.1);border-radius:4px;padding:2px;font:inherit;font-size:8px;line-height:1;color:#102845;background:#fff;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.alogw-table textarea{height:21px;resize:none}.alogw-table input[type=checkbox]{width:auto;height:auto}
