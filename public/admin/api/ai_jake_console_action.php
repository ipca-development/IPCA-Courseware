...
function build_steven_artifact_content(array $requestRow, array $contextFiles): array
{
    ...
    $systemPrompt = implode("\n", [
		...
		'- If DATABASE SCHEMA is provided, treat it as authoritative and extract real table/column names from it.',
		'- If PROJECT FILE INDEX is provided, treat it as the available project structure.',
		'- Do NOT say you cannot access files, schema, or project structure when they are present in the prompt.',
		'- When asked to list methods, tables, or structures, extract them explicitly from the provided context.',
		...
		'- If functionality is missing, explicitly state which method is missing instead of guessing.',
