...
$narr = (string)($stmt->fetchColumn() ?: '');

// refs
$stmt = $pdo->prepare("SELECT ref_type, ref_code, ref_title, confidence, notes FROM slide_references WHERE slide_id=? AND ref_type IN ('PHAK','ACS') ORDER BY ref_type, id");
$stmt->execute([$slideId]);
