...
(function() {
  ...
  const insetMapProfile = document.getElementById('insetMapProfile');
  ...
  function updateAttitudeIndicator(view, sample, dtSec = 1 / 60, snap = false) {
    ...
    const pitchLadderFullRadius = clamp(Math.min(width, height) * 0.34, 150, 330);
    const pitchLadderOuterRadius = pitchLadderFullRadius / 0.68;
