...
<head>
    <meta charset="utf-8">
    <title>User Accounts · IPCA Courseware</title>
...
<div class="app-shell">
    <?php if ($nav !== ''): ?>
        <aside class="app-sidebar"><?php echo $nav; ?></aside>
    <?php endif; ?>
        ...
        <div class="app-topbar">
            <div class="app-topbar-inner">
                <div class="app-topbar-title-block">
                    <div class="app-topbar-overline">Operations</div>
                    <h1 class="app-topbar-title">User Accounts</h1>
                </div>
            </div>
        </div>
