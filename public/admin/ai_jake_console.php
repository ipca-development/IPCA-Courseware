...
<style>
  ...
  @media (max-width: 1200px){
    ...
    .chat-composer-float{left:24px}
  }

  @media (max-width: 820px){
    .jake-shell{padding-bottom:122px}
    .chat-composer-float{left:12px;right:12px;bottom:12px}
    .chat-input-grid{grid-template-columns:1fr}
  }
</style>
