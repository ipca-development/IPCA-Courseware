  ...
  <section class="ptv4-card" data-ptv4-card data-card-state="ready" aria-label="Progress test workspace">
    <div class="ptv4-card-body">
      ...
      <div class="ptv4-yesno-fallback" data-ptv4-yesno-fallback hidden aria-hidden="true">
        <p class="ptv4-yesno-fallback-label">Or tap your answer:</p>
...
<?php require __DIR__ . '/partials/progress_test_v4_report_modal.php'; ?>
...
<script src="/assets/progress_test_v4.js?v=38"></script>
<?php cw_footer(); ?>
