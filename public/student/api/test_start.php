...
$payload = [
  ...
  "input" => [
    ["role"=>"system","content"=>[["type"=>"input_text","text"=>"You are a strict flight instructor. Summarize this test session, identify weak areas, and give concrete remediation instructions (e.g., which slide numbers to review)."]]],
...
try {
    ...
    // For text responses, your helper may differ; simplest:
