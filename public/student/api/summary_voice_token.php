...
try {
    ...
    $instructions =
        ...
        . "When the student says they are done or asks for review, call analyze_summary_draft before responding. Review their actual written summary; do not rewrite it for them.\n"
