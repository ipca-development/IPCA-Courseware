...
- Canonical Letter furniture uses an 84px header band and a 34px footer band. Header logos are constrained to the header's usable 72px height; furniture must not expand either band.
